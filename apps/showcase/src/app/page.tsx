...
export default function Home() {
  return (
    <main className="w-full h-full container flex flex-col justify-center items-center gap-4">
      <span className="text-xl sm:text-2xl font-medium text-indigo-600 dark:text-indigo-400">
        Introducing
      </span>
      <h1 className="text-4xl sm:text-5xl font-bold text-center">
        A New Intuitive Way Of Building
      </h1>
      <p className="text-lg sm:text-xl max-w-xl text-center text-foreground/80">
